.config files to quickly configure various zsh shell, git, and various programming lanagues. My configuration files include terminal theming, plugins, and command aliases.
